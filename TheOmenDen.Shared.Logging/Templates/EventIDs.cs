...
public static class EventIDs
{
    ...
    /// </value>
    public static readonly EventId EventIdAppThrown = new(EventIdIdentifier.AppThrown.Id, EventIdIdentifier.AppThrown.ToString());
    /// <summary>
    ...
    /// </value>
    public static readonly EventId EventIdHttpClient = new(EventIdIdentifier.HttpClient.Id, EventIdIdentifier.HttpClient.ToString());
    /// <summary>
    ...
    /// </value>
    public static readonly EventId EventIdPipelineThrown = new(EventIdIdentifier.PipelineThrown.Id, EventIdIdentifier.PipelineThrown.ToString());
    /// <summary>
    ...
    /// </value>
    public static readonly EventId EventIdUncaught = new(EventIdIdentifier.UncaughtInAction.Id, EventIdIdentifier.UncaughtInAction.ToString());
    /// <summary>
    ...
    /// </value>
    public static readonly EventId EventIdUncaughtGlobal = new(EventIdIdentifier.UncaughtGlobal.Id, EventIdIdentifier.UncaughtGlobal.ToString());
}